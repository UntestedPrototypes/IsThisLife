...
uint8_t robotMacs[NUM_ROBOTS][6] = {
    {0x88, 0x57, 0x21, 0x6A, 0x09, 0x9C}, //ID 1
    {0xB0, 0xCB, 0xD8, 0xC1, 0x53, 0xAC}, //ID 2
    {0x28, 0x05, 0xA5, 0x70, 0x53, 0x1C}, //ID 3
    {0x28, 0x05, 0xA5, 0x6F, 0x3B, 0xF8}, //ID 4
    {0xB0, 0xCB, 0xD8, 0xC7, 0x54, 0x3C}  //ID 5
};
